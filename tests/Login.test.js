...
//         await page.type('input[name=name]', 'molinacarlosj');
//         await page.click('input[name=password]');
//         await page.type('input[name=password]', 'Dejesus28');
...
//         expect(html).toBe('molinacarlosj');
//     }, 1600000);
// });
...
describe('Login', () => {
    test('users can login', async () => {
        ...
        await page.type('input[name=name]', 'molinacarlosj');
        await page.click('input[name=password]');
        await page.type('input[name=password]', 'molinacarlosj');
        await page.click('button[type=submit]');
        //await page.waitForSelector('[data-testid="homepage"]');
